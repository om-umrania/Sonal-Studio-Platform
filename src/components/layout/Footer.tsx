      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-cream/50 leading-relaxed mt-3">
              {SITE.description}
            </p>
            <p className="text-sm text-cream/50 mt-3">{SITE.location}</p>
          </div>

          {/* Services column */}
          <div>
            <h3 className="text-xs font-semibold uppercase tracking-[0.2em] text-gold mb-5">
              Services
            </h3>
            <ul className="space-y-2.5">
              {[
                { label: "Celebration Styling", href: "/services#celebration-styling" },
                { label: "Wedding Consultation", href: "/services#wedding-consultation" },
                { label: "Custom Fashion", href: "/services#custom-fashion" },
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              ...
              >
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 text-whatsapp shrink-0" aria-hidden="true">
        ...
        <div className="mt-12 pt-6 border-t border-cream/10 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-cream/30">
            © {new Date().getFullYear()} Sonal Studio. Nagpur, Maharashtra.
          </p>
          <p className="text-xs text-cream/20">
            Custom fashion & celebration styling with care.
          </p>
        </div>
      </div>
    </footer>
