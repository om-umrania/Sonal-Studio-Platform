      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <Link
              href="/"
              className="font-display text-xl md:text-2xl text-maroon tracking-wide leading-none"
            ...
            <a
              ...
              className="hidden md:inline-flex items-center gap-2 px-5 py-2.5 rounded-pill bg-maroon text-cream text-sm font-semibold hover:bg-wine transition-colors duration-200"
            >
            ...
            >
              <motion.span
                className="block w-6 h-0.5 bg-maroon origin-center"
